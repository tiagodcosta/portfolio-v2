...
const About = () =>  (
  <Container>
    <Content>
      ...
      <Text>Currently, I work as UI Developer at Northeastern University and on the local nonprofit Boston Dhammakaya Foundation, where I have the opportunity to combine my previous technical experience with my knowledge of User Experience (UX).</Text>
